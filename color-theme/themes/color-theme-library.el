...
XEmacs color theme."
  ...
  (color-theme-install
   '(color-theme-xemacs
    ...
    (diff-added ((t (:background "#8FB390"))))
    (diff-removed ((t (:background "#B38481"))))
    (diff-changed ((t (:background "#AEB37A"))))
